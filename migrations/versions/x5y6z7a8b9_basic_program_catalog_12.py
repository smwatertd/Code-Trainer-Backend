...
revision: str = "x5y6z7a8b9_basic_program_12"
down_revision: Union[str, Sequence[str], None] = "w3x4y5z6a7"
...
def upgrade() -> None:
    ...
    if len(rows) != BASIC_PROGRAM_SIZE:
        raise RuntimeError(f"Expected {BASIC_PROGRAM_SIZE} tasks in seed, got {len(rows)}")
