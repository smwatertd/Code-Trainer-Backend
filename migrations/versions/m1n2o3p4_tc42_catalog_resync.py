"""Re-sync TC42 catalog payloads (indentation, code_examples, templates)."""
...
revision: str = "m1n2o3p4_tc42_resync"
down_revision: Union[str, Sequence[str], None] = "l0m1n2o3_tc42_test_cases"
