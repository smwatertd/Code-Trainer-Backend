"""Expand beginner tracks to 24 tasks (basic program + input/output)."""
...
revision: str = "h5i6j7k8_expand_tracks_24"
down_revision: Union[str, Sequence[str], None] = "g4h5i6j7k8_multilang_tracks"
